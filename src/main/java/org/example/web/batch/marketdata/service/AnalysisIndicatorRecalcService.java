...
public interface AnalysisIndicatorRecalcService {

    /**
     * INSERT された財務諸表1件分から analysis_indicators を再計算し、
     * 存在すれば UPDATE、存在しなければ INSERT する（FinancialStatementItemWriter から呼ばれる）。
     */
    void recalc(FinancialStatementEntity statement);
}
